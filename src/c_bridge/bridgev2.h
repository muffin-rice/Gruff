...
#ifndef OPEN_SPIEL_GAMES_BRIDGEV2_H_
#define OPEN_SPIEL_GAMES_BRIDGEV2_H_
...
class Bridgev2State : public State {
 public:
...
class Bridgev2Game : public Game {
 public:
...
#endif  // OPEN_SPIEL_GAMES_BRIDGEV2_H_
